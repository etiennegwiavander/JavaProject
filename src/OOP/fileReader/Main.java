...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            while (data != -1) {
//              System.out.print((int)data); // converting the (int)data to (char)data makes it posible for the actual characters of ASCII code to be read instead of it's integer
